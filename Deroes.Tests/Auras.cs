...
public class Auras
{
	...
	public void Might_Activate_On_Paladin_Lvl_1()
	{
		...
		var player = new Hero("", new PaladinSetup());
	...
	public void Resist_Fire_Activate_Level5_ShouldBeAround85_On_Hero()
	{
		...
		var resistFire = new ResistFire(hero); 
		resistFire.SetupLevel(5);	// ~85 but max is 75
		resistFire.Set();
	...
	[TestMethod]
	[ExpectedException(typeof(ArgumentOutOfRangeException))]
	public void Resist_Fire_Level_Negative_ShouldThrow()
	{
		ResistFire.CalculateBonusResist(-1);
	}
